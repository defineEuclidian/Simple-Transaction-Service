...
/**
 * LoadResponse class for storing the result of a load.
 */
public class LoadResponse {
    ...
    /**
     * Parameterized constructor for LoadResponse.
     * 
     ...
     */
    public LoadResponse(String messageId, String userId, ResponseCode responseCode, Amount balance) {
